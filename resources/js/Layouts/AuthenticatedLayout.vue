...
const deviceName = ref("Belum terhubung");
...
const connect = async () => {
    ...
    try {
        ...
        deviceName.value = `Tersambung ke printer`;
    } catch (error) {
    ...
    <div>
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-white border-b border-gray-100">
                ...
                <div class="w-full-7xl px-4 sm:px-6 lg:px-8">
            ...
            <header class="bg-white shadow" v-if="$slots.header">
                <div class="max-w-7xl pt-4 pr-4 pb-4 pl-0 sm:pt-4 pr-4 pb-4 pl-0 lg:pt-4 pr-4 pb-4 pl-12 ml-7 ">
                    <slot name="header" />
                </div>
            </header>
